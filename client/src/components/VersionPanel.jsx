...
const VersionPanel = ({
  ...
  return (
    <aside className="history-panel version-panel">
      <div className="history-header">
        <div>
          <h3>Version History</h3>
          <p className="history-subtitle">Preview snapshots, compare changes, and restore safely.</p>
        </div>
        <button className="close-btn" onClick={onClose}>×</button>
      </div>

      <div className="version-panel-layout">
        <div className="version-panel-sidebar">
          ...
          <div className="version-list-shell">
            {loading ? (
        ...
        <div className="version-panel-main">
          {!selectedVersionId ? (
            ...
            <>
              <div className="version-toolbar">
                ...
                >
                  <RotateCcw size={15} />
                  {restorePendingId === selectedVersion.versionId ? 'Restoring...' : 'Restore this version'}
                </button>
              </div>
